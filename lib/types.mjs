 ...
 *
 * @typedef {'session_seen' | 'session_progress' | 'session_link' | 'session_unlink' | 'alias_set' | 'parent_set' | 'close' | 'sweep' | 'manual_link' | 'ai_title_seen' | 'name_set' | 'pr_link_seen' | 'codex_session_seen' | 'session_prune'} EventOp
 */
 ...
 * @property {string[]} [codex_session_ids]
