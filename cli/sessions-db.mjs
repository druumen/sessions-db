...
const COMMANDS = {
  ...
  harvest: () => import('./harvest.mjs'),
  'ingest-codex': () => import('./ingest-codex.mjs'),
...
function printRootHelp() {
  ...
  '  names         Show every name a session has had (per channel + history)',
    ...
    '  harvest       Backfill names + MR links from transcripts on disk (dry run by default)',
    '  ingest-codex  Register codex sessions from ~/.codex rollouts (dry run by default)',
