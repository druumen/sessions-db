...
export { resolveDisplayName, displayNameForSession, nameValuesFromSession, NAME_PRECEDENCE, CHANNEL_ALIAS, CHANNEL_CC_CUSTOM_TITLE, CHANNEL_CC_AI_TITLE, CHANNEL_AGENT_NAME, CHANNEL_FIRST_PROMPT, KNOWN_CHANNELS, SOURCE_HUMAN, SOURCE_LLM, SOURCE_HARVEST, isValidChannel, isValidSource, isValidNameValue, isKnownChannel, findNameEntry, currentNameValue, foldNameHistory, splitChannelHistory, sortChannels, nameChangeFromEvent, nameSetPayload, NAME_BEARING_OPS, MAX_CHANNEL_LEN, MAX_SOURCE_LEN, MAX_NAME_VALUE_LEN, MAX_CHANNELS_PER_SESSION } from "./names.mjs";
